...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Publication.aceptation_date'
        db.alter_column('web_publication', 'aceptation_date', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Publication.publication_date'
        db.alter_column('web_publication', 'publication_date', self.gf('django.db.models.fields.DateField')(default=None))
