...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('web_publication', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=100, separator=u'-', blank=True, default='', populate_from='title', overwrite=False, db_index=True), keep_default=False)

        # Adding field 'Project.slug'
        db.add_column('web_project', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=100, separator=u'-', blank=True, default='', populate_from='name', overwrite=False, db_index=True), keep_default=False)

        # Adding field 'Person.slug'
        db.add_column('web_person', 'slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=100, separator=u'-', blank=True, default='', populate_from='name', overwrite=False, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Publication.slug'
        db.delete_column('web_publication', 'slug')

        # Deleting field 'Project.slug'
        db.delete_column('web_project', 'slug')

        # Deleting field 'Person.slug'
        db.delete_column('web_person', 'slug')
